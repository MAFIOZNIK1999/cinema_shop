...
import cinema.shop.spring.dto.request.MovieSessionRequestDto;
import cinema.shop.spring.dto.response.MovieSessionResponseDto;
import cinema.shop.spring.model.MovieSession;
import cinema.shop.spring.service.MovieSessionService;
import cinema.shop.spring.service.mapper.MovieSessionMapper;
...
public class MovieSessionController {
    ...
    @GetMapping("/id")
    public MovieSessionResponseDto findById(@PathVariable Long id) {
